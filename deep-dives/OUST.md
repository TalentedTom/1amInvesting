...
REV8 OS Family — announced May 4, 2026. World's FIRST native color LiDAR (depth + color, NO camera needed). Powered by new L4 chip: DOUBLES range and resolution vs prior gen. 10.4 million points per second. 200-meter detection on road signs. Auto-grade standards qualified. Partners: Google (Waymo) + Volvo confirmed adoption plans. Samples shipping JULY 2026. Stock: +10% on announcement.
...
**Q1 (Today):** Digital LiDAR for smart infrastructure (BlueCity 1,200+ sites), industrial automation, logistics.

**Q2 (3-5 Years — Phase 2):** Full-stack perception for autonomous vehicles, humanoid robots, drones, UGVs.

**Q3 (5+ Years — Phase 3):** Universal Physical AI perception primitive + defense platforms + consumer robotics.

**REV8 TAM EXPANSION (NEW):** Native color LiDAR EXPANDS the TAM by eliminating cameras. Every application currently using LiDAR + camera can now use ONE sensor. Camera market partially cannibalized → LiDAR TAM expands.

## Financial Snapshot (to be updated post-earnings May 5)

- FY2025: $169.4M (+52% YoY, +32% ex-royalties). Record 25,000+ sensors shipped.
- Q4 2025: $62.2M (+107%). Product revenue $41M (+36%). 8,100 sensors (record). GAAP profit $26M.
- Q1 2026 guided: $45-48M (beat consensus $42.72M). Includes 7 weeks Stereolabs.
- Bookings FY2025: $177M (B/B 1.2x). Software-attached bookings doubled.
- Cash: $211M. No debt.
- Stereolabs: $16M revenue, 90K cameras, 10K+ customers.
- Long-term: 30-50% annual revenue growth, 35-40% GAAP GM.

## Scoring Breakdown (RESCORED May 4 — REV8)
...
## REV8 Competitive Analysis

OUST REV8 (digital, native color): 10.4M pts/sec, 200m range, color+depth ONE sensor. L4 custom silicon, software-defined updates. Auto-grade, Google/Volvo validated. Digital architecture = moat WIDENS every generation.

Luminar (analog, no color): Fewer points, no native color. Mechanical scanning = wear parts. Stock down 90%+ from peak. Cannot add color without full redesign.

Hesai/RoboSense (analog, Chinese): No native color. NDAA risk for US/NATO.

OUST is the SIVE of autonomy: Only digital + native color LiDAR. Everyone else committed to wrong architecture.

## Defense Vector (Emerging)

- "Significant interest in battlefield automation" — Q4 call
- NDAA compliant, US-headquartered
- REV8 native color = robots SEE in 3D color with ONE sensor
- Humanoid robots (Unitree) need LiDAR for spatial awareness
- NATO 5% GDP + drone warfare = inevitable demand

## Key Risks

- LiDAR competition exists — BUT REV8 widened the moat significantly
- Profitability ex-royalties unproven (2026 royalties <$5M vs $23M in 2025)
