...
## Core Thesis: Memory as Strategic Asset — But #3 in HBM

Micron just posted the most extraordinary quarter in memory industry history. Revenue nearly tripled YoY. Gross margin expanded from 37% to 75%. Q3 guidance ($33.5B single-quarter) exceeds Micron's full-year revenue for EVERY year through FY2024. Memory is now a "strategic asset" with demand "substantially short of supply." But Micron is #3 in HBM behind SK Hynix (43%) and Samsung (33%), banned in China, and at $460B market cap has zero information edge.

## Q2 FY2026 — Records Everywhere
...
| DRAM | $18.8B (79%) | +207% |
| NAND | $5.0B (21%) | +169% |
| Gross Margin | **75%** | +38pp |
| Operating Margin | **69%** | record |
| Non-GAAP EPS | **$12.20** | +682% |
| Net Income | $13.8B | +773% |
| FCF | $6.9B | record |
| Operating Cash Flow | $11.9B | +202% |

## Q3 FY2026 Guidance — Another Record

- Revenue: **$33.5B** ±$750M (+40% QoQ!)
- Gross Margin: **~81%**
- Non-GAAP EPS: **$19.15** ±$0.40
- "We anticipate exceptional records across revenue, gross margin, EPS and free cash flow"

This single-quarter guidance exceeds Micron's FULL-YEAR revenue through FY2024.

## Business Unit Breakdown

| Unit | Q2 Revenue | Key Driver |
|------|-----------|-----------|
| Cloud Memory | $7.75B (+160%) | HBM + server DRAM |
| Core Data Center | $5.69B | Enterprise SSD + DDR5 |
| Mobile & Client | $7.71B | LPDDR5 + client SSD |
| Auto & Embedded | $2.71B | Automotive DRAM |

## HBM Position

- HBM market: ~$62B in 2026 (TrendForce), +100% YoY
- **SK Hynix: ~43% share** (leader, NVIDIA primary)
- **Samsung: ~33% share** (recovering)
- **Micron: ~24% share** (#3, gaining)
- HBM4: volume shipments started for NVIDIA Vera Rubin
- HBM4 16-high sampled: 48GB (+33% capacity)
- HBM4E: development underway, volume ramp CY2027
- HBM carries 3:1 trade ratio (3x wafer capacity of standard DRAM)

## Scoring Breakdown

| Category | Score | Evidence |
|----------|-------|---------|
| Core Thesis | 11/20 | Revenue +196%. GM 75%→81%. Memory supply constrained. "Strategic asset." BUT: #3 in HBM (-3). $460B MC = mega-cap (-3). China ban (-2). Memory is cyclical (-1). |
| Cycle Stage | 10/10 | EVERY metric at record. Revenue nearly tripled. Q3 guide $33.5B. GM 81%. Cannot score higher. |
| TAM | 8/10 | HBM: $62B. Total memory: $200B+. AI driving structural demand shift. DC DRAM+NAND >50% of industry TAM first time. |
